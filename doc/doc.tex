...
O algoritmo de {\it Floyd Warshall} é um método usado no cálculo do caminho mais curto entre todos os pares de vértices em um grafo orientado (com direção) e valorado (com peso).
...
No caso do trabalho prático, uma matriz é contruida, atribuindo-se o valor 1 para posições representando arestas existentes e {\it infinito} para as demais.
